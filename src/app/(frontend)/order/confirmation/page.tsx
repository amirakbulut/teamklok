    ...
    <div className="container max-w-2xl mx-auto py-8">
      <Card>
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl text-green-600">Bestelling bevestigd!</CardTitle>
          <p className="text-muted-foreground">
            Je bestelling is opgenomen. Betaal bij bezorging of afhaling.
          </p>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <span className="font-medium">Betalingsmethode:</span>
                <br />
                <span className="capitalize">
                  {order.paymentMethod === 'cash'
                    ? 'Contant'
                    : order.paymentMethod === 'cash_pin'
                      ? 'Contant met pin'
                      : 'Online'}
                </span>
              </div>
          ...
          <div className="bg-yellow-50 p-4 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-yellow-900">Betalingsinformatie</h3>
                <p className="text-sm text-yellow-800 mt-1">
                  Je betaalt {formatToEuro(order.orderTotal)} bij bezorging of afhaling. Houd het
                  exacte bedrag klaar.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800 mt-1">
                  Je bestelling wordt verwerkt door onze keuken. We nemen contact met je op voor de
                  bezorging en bevestigen de exacte bezorgtijd.
                </p>
              </div>
            </div>
          </div>
